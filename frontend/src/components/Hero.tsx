  ...
  return (
    <section id="hero" className="pt-16 pb-20">
      <div className="max-w-5xl mx-auto px-5">
        {/* Badge */}
        <div className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full bg-[#0D1428] border border-[#1E2D4A] text-[11px] text-[#8A9BB5] mb-6">
        ...
        <h1 className="text-4xl sm:text-5xl font-bold tracking-tight leading-[1.1] mb-4 text-white">
          ...
          <br />
          <span className="text-[#4A5670]">from real complaints</span>
        </h1>

        {/* Description */}
        <p className="text-[15px] text-[#8A9BB5] leading-relaxed max-w-xl mb-8">
        ...
        <div className="flex items-center gap-3 mb-12">
          <button
            onClick={onExplore}
            className="px-4 py-2 bg-[#00D4AA] text-[#0A0F1E] text-[13px] font-semibold rounded-lg hover:bg-[#00E6B8] transition-colors"
          >
            Browse Ideas
          </button>
          <button
            ...
            className="px-4 py-2 bg-[#0D1428] text-[#8A9BB5] text-[13px] font-medium rounded-lg border border-[#1E2D4A] hover:border-[#253556] hover:bg-[#111A33] transition-all"
          >
            How It Works
          </button>
        </div>
        ...
        <div className="grid grid-cols-2 sm:grid-cols-4 gap-3">
          <div className="bg-[#0D1428] border border-[#1E2D4A] rounded-xl p-4">
            <div className="overline mb-1">Subreddits</div>
            <div className="text-2xl font-bold text-white tabular-nums">
              {subCount}
            </div>
            <div className="text-[11px] text-[#4A5670] mt-0.5">
              Web3 communities
            </div>
          </div>
          <div className="bg-[#0D1428] border border-[#1E2D4A] rounded-xl p-4">
          ...
          <div className="bg-[#0D1428] border border-[#1E2D4A] rounded-xl p-4">
            ...
            <div className="text-2xl font-bold text-[#F5A623] tabular-nums">
              {avgScore}
            </div>
            <div className="text-[11px] text-[#4A5670] mt-0.5">
              out of 100
